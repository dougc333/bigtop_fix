...
export ALLUXIO_JAVA_OPTS+="
  ...
  -Dalluxio.worker.hierarchystore.level0.dirs.path=$ALLUXIO_RAM_FOLDER
  -Dalluxio.worker.hierarchystore.level0.dirs.quota=$ALLUXIO_WORKER_MEMORY_SIZE
  -Dalluxio.underfs.address=$ALLUXIO_UNDERFS_ADDRESS
  -Dalluxio.underfs.hdfs.impl=$ALLUXIO_UNDERFS_HDFS_IMPL
  -Dalluxio.data.folder=$ALLUXIO_UNDERFS_ADDRESS/tmp/tachyon/data
  -Dalluxio.workers.folder=$ALLUXIO_UNDERFS_ADDRESS/tmp/tachyon/workers
